...
function esPar(num) {
  ...
  // Tu código:
  var espar = num % 2;
  if (espar === 0) {return true} else { return false};
 }
...
function esImpar(num) {
  ...
  // Tu código:
  var esImpar = num % 2
  if (esImpar >= 1) {return true} else {return false};
...
function esVocal(letra){
  ...
  else if (letra === "a" ||letra === "e"|| letra === "i"||letra === "o"||letra === "u") {return "Es vocal"} else {return "Dato incorrecto"};
